...
export declare class X64Assembler {
    ...
    sar_r_c(dest: Register, chr: number, size?: OperationSize): this;
    sal_r_c(dest: Register, chr: number, size?: OperationSize): this;
    private _movsx;
    ...
    save(): Uint8Array;
    toScript(bdsxLibPath: string, exportName?: string): {
        js: string;
        dts: string;
    };
