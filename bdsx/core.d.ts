...
export interface VoidPointerConstructor {
    new (): VoidPointer;
    fromAddress<T extends VoidPointer>(this: {
        new (): T;
    }, addressLow: number, addressHigh?: number): T;
    fromAddressBin<T extends VoidPointer>(this: {
        new (): T;
    }, addressBin: string): T;
    fromAddressBuffer<T extends VoidPointer>(this: {
        new (): T;
    }, buffer: Bufferable): T;
    fromAddressString<T extends VoidPointer>(this: {
        new (): T;
    }, str: string): T;
    fromAddressFloat<T extends VoidPointer>(this: {
        new (): T;
    }, value: number): T;
}
...
export interface VoidPointer {
    ...
    as<T extends VoidPointer>(ctor: {
        new (): T;
    }): T;
    addAs<T extends VoidPointer>(ctor: {
        new (): T;
    }, lowBits?: number, highBits?: number): T;
    subAs<T extends VoidPointer>(ctor: {
        new (): T;
    }, lowBits?: number, highBits?: number): T;
    addBinAs<T extends VoidPointer>(ctor: {
        new (): T;
    }, bin: string): T;
    subBinAs<T extends VoidPointer>(ctor: {
        new (): T;
    }, bin: string): T;
}
/**
...
export declare class PrivatePointer extends VoidPointer {
    ...
    protected getNullablePointerAs<T extends VoidPointer>(ctor: {
        new (): T;
    }, offset?: number): T | null;
    protected getPointer(offset?: number): NativePointer;
    protected getPointerAs<T extends VoidPointer>(ctor: {
        new (): T;
    }, offset?: number): T;
